...
WINPLUS_FUNC_IMPL(int64) StrToInt64( AnsiString const & num_str, int ibase )
{
    return (int64)str_to_xq( num_str.c_str(), NULL, ibase, 0 );
}

WINPLUS_FUNC_IMPL(uint64) StrToUint64( AnsiString const & num_str, int ibase )
{
    return str_to_xq( num_str.c_str(), NULL, ibase, FL_UNSIGNED );
}

WINPLUS_FUNC_IMPL(int) Random( int n1, int n2 )
{
...
{
    _construct(); // call the default constructor
