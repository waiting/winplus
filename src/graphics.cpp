...
void DrawRoundRectangle( Gdiplus::Graphics & g, Gdiplus::Pen const & pen, Gdiplus::RectF const & rect, Gdiplus::REAL round )
{
...
void FillRoundRectangle( Gdiplus::Graphics & g, Gdiplus::Brush const & brush, Gdiplus::RectF const & rect, Gdiplus::REAL round )
{
	Gdiplus::GraphicsPath path;
	path.StartFigure();
...
//////////////////////////////////////////////////////////////////////
MemDC::MemDC( void )
: _hMemDC(NULL), _hBitmap(NULL), _width(0), _height(0), _background(0), _transparent(0), _isTransparent(FALSE)
{
}
